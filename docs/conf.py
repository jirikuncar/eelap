...
project = 'EELAP'
copyright = '2014, Jiri Kuncar <jiri.kuncar@gmail.com>'
...
latex_documents = [
  ('index', 'EELAP.tex', 'EELAP Documentation',
   'CERN', 'manual'),
]
...
man_pages = [
    ('index', 'eelap', 'EELAP Documentation',
     ['CERN'], 1)
]
...
texinfo_documents = [
  ('index', 'EELAP', 'EELAP Documentation',
   'Jiri Kuncar <jiri.kuncar@gmail.com>', 'EELAP', 'One line description of project.',
   'Miscellaneous'),
]
